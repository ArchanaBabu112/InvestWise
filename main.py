...
loader = PyPDFLoader(r'C:\Users\ASUS\Downloads\Desktop\Projects\Investment_Management\Investment Management.pdf')
...
You are an Investment Advisor. Use the provided context to answer user questions related to investments.
...
context, inform the user. Do not use any other information for answering user. Provide concise and clear answers.
...
st.title("InvestWise")
st.subheader("Your trusted Investment Managment Chatbot")
...
def initialize_session_state():
    ...
    if 'generated' not in st.session_state:
        st.session_state['generated'] = ['Hello! Ask me anything about Investments.']
...
def display_chat_history():
    ...
    with container:
        ...
        with st.form(key='my_form', clear_on_submit=True):
            user_input = st.text_input("Question:", placeholder="Ask about your Investments", key='input')
